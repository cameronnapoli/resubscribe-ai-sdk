 ...
 */
var registerEvent = function (eventType, user) { return __awaiter(void 0, void 0, void 0, function () {
    var email_re, url, body, headers, response, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                error_1 = _a.sent();
                console.error("Resubscribe: Failed to register event. Error: ".concat(error_1));
                return [3 /*break*/, 4];
